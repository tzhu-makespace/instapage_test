...
window.instapageFormSubmitSuccess = function (form) {
  ...
  var storageDurationValue = storageDurationInput
    ? storageDurationInput.value
    : "";
  ...
  req.onreadystatechange = function () {
    ...
    var baseStyles =
      'text-align: center; font-weight: 600; font-size: 14px; font-family: "Montserrat", "Arial", sans-serif;';
    ...
    if (this.readyState == 4) {
      if (this.status === 200 || this.status === 201) {
        ...
        formResponseEl.innerHTML =
          "Thanks! We’ll be in touch with you very soon.";

        if (window.makespacePostLeadSubmitRedirect) {
          window.makespacePostLeadSubmitRedirect();
        }
        ...
        baseStyles += " margin-top: -4px; color: #f12222;";
        formResponseEl.innerHTML =
          "Sorry, there was an error. Give us a call and we’ll get you set up ASAP!";
      }
  ...
  req.send(JSON.stringify(window.makespaceFormatFormData(params)));
};
